...
document.addEventListener('DOMContentLoaded', () => {
   ...
   if (headline && paragraph) {
      ...
      const textSets = [
         {
            h1: "Надежная поддержка для бизнеса",
            p: "Помогаем создавать и сопровождать компании, оформлять визы и защищать интересы в государственных органах. Мы делаем сложные вопросы простыми и безопасными для вас."
         },
         {
            h1: "Визовая поддержка<br>и сопровождение",
            p: "Обеспечиваем оформление всех видов виз, легализацию документов и юридическое сопровождение иностранных граждан для вашего бизнеса и личных целей."
         },
         {
            h1: "Регистрация и сопровождение компаний",
            p: "Полный цикл услуг по регистрации ОсОО и других юридических лиц, бухгалтерское сопровождение и защита интересов компании при взаимодействии с государственными органами."
         }
      ];
